...
local bottom_output = first_generation.jobs[1].output_layer
local top_output = first_generation.jobs[2].output_layer
...
assert(
	combined_generation.jobs[1].output_layer.name == "Combined_normal",
	"Combined generation should create a clearly named output"
)

sprite:deleteLayer(combined_generation.jobs[1].output_layer)
NormalMapGenerator:regenerate_last()
